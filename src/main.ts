...
async function bootstrap() {
  ...
  await app.listen(3000); //app.listen inicia o aplicativo na porta 3000. Isso fará com que o aplicativo comece a ouvir por solicitações HTTP na porta especificada.
}
